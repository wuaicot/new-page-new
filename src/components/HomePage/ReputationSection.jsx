  ...
  return (
    ...
    >
      <div className="text-center ">
        <h2 className="text-5xl text-sky-500 font-bold mt-0 mb-10 tracking-wide sm:-pb-20 sm:pt-0 sm:-mt-10">
          Enhance Your Reputation
        </h2>
        <p className="text-justify text-lg font-bold text-blue-950 max-w-3xl mx-8 my-8">
          People believe what they ‘see’. Revolutionise your online identity
          with our digital marketing and ORM services to reach the next level!
        </p>
        <button
          className="shadow-lg mt-8 px-4 sm:py-2
