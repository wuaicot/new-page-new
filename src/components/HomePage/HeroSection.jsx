export default function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center h-screen text-center bg-fixed bg-cover bg-center" 
      ...
      <p className="text-justify text-lg font-bold text-blue-950 max-w-3xl mx-4 my-12">
      ...
      <button className="shadow-lg mt-8 py-1 px-4 bg-orange-600 hover:bg-blue-600 text-white rounded-lg text-lg font-medium transition-all">
