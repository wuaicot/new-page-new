  ...
  return (
    ...
    style={{ backgroundImage: "url('/assets/4725777_19276.jpg')",
     ...
     zIndex: 0,
      ...
      <h2 className="md:translate-x-0 md:-translate-y-20 text-5xl text-sky-500 font-bold mt-60 sm:mb-0 tracking-wide">Who Are We?</h2>
      <p className="md:translate-x-0 lg:translate-x-80  md:-translate-y-20 mr-12 text-lg font-bold text-blue-950 max-w-3xl  text-right mx-4 my-6">
      ...
      <p className="lg:translate-x-80 md:translate-x-0 md:-translate-y-20 mr-12 text-right text-lg font-bold text-blue-950 max-w-3xl mx-4 text-justify">
      ...
      <p className="sm:translate-x-full md:translate-x-0 md:-translate-y-20 lg:translate-x-2/4 lg:mr-40  text-right text-lg font-bold text-blue-950 max-w-3xl  my-6 mx-12 text-justify">
      ...
      <a
        href="#testimonials"
        className="mt-2  inline-block px-6 py-3 my-48 bg-teal-400 text-black font-medium rounded hover:bg-teal-500 transition md:translate-x-60 "
      >
