  ...
  return (
    ...
    style={{ backgroundImage: "url('/assets/4725777_19276.jpg')",
     ...
     zIndex: 0,
      ...
      <p className="md:translate-x-0 lg:translate-x-80  md:-translate-y-1/4 mr-12 text-md font-bold text-blue-950 max-w-3xl  text-right mx-4  sm:mb-0 sm:mt- sm:mb-4 text-justify">  
      ...
      <p className="sm:translate-x-full md:translate-x-0 md:-translate-y-2/3
       
      lg:translate-x-2/4 lg:mr-40  text-right text-md font-bold text-blue-950 max-w-3xl  my-6 mx-12 text-justify">
