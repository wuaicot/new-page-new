  ...
  return (
    ...
    style={{ backgroundImage: "url('/assets/rb_177769.png')",
     ...
     id="who-are-we">
      ...
      <h2 className="text-5xl text-center text-sky-500 font-bold mt-40 mb-12 tracking-wide sm:translate-y-10">Who Are We?</h2>
      <p className=" text-md font-bold text-blue-950 max-w-3xl  text-center mb-4  text-justify text-center tracking-wide sm:mx-20">  
      ...
      <p className="sm:mx-20 tracking-wide  text-md font-bold text-blue-950 max-w-3xl  text-center mb-4  text-justify text-center sm:-translate-y-12">
