  ...
  return (
    ...
    >
      <div className="justify-center items-center flex flex-col">
        <h2 className="text-5xl text-center text-indigo-800 font-bold mt-40 mb-12 tracking-wide md:-translate-x-1/2 sm:translate-y-8">
          Who Are We?
        </h2>
        ...
        <p
          className="sm:mx-20 text-md font-bold text-blue-950 max-w-3xl  text-center mb-12  text-justify text-center tracking-wide
      text-center
      mb-4 md:translate-y-0 md:-translate-y-3"
        ...
        <a
          href="#testimonials"
          className="animate-pulce   inline-block  px-6 py-1  bg-teal-400 text-indigo-800 font-medium rounded hover:bg-teal-500 transition-full 
         sm:mb-40 
